...
<html lang="en-US" xml:lang="en-US" xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<table style="margin:0px" border="0" cellspacing="0" cellpadding="0">
			<tr valign="middle">
				<td><img hspace="0" alt="[xz]" border="0" usemap="latest/map.html#xz"
					 src="latest/y$y_pos.png" /></td>
				<td><img alt="[3d]" border="0" src="plot.pl" /></td>
			</tr>
			<tr>
				<td><img hspace="0" alt="[xy]" border="0" usemap="map.html#xy"
					 src="latest/z$z_pos.png" /></td>
				<td><img hspace="0" alt="[yz]" border="0" usemap="map.html#yz"
